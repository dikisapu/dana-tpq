          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p> <?php
                  ...
                  <?php echo $myData['nama']; ?>
                  <br>
                  <small>[<?php echo $myData['level_user']; ?>]</small>
                <?php } ?>
              </p>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="modul/laporan/laporanspp.php" target="_blank"><i class="fa fa-circle-o"></i> Laporan SPP</a></li>

                <li><a href="?open=formcetakkeuangan"><i class="fa fa-circle-o"></i> Laporan Keuangan</a></li>

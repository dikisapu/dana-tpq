                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="id_santri" required>
                                            ...
                                            <?php
                                            $mysql = "select * from santri WHERE id_santri AND nis='$_SESSION[username]'";
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="col-sm-10">
                    <select class="form-control" name="metode_pembayaran">
                      <option value="<?php echo $myData['metode_pembayaran']; ?>"><?php echo $myData['id_spp']; ?>-<?php echo $myData['metode_pembayaran']; ?>-</option>
                      <option value="Transfer Bank">Transfer Bank</option>
                      <option value="Tunai">Tunai</option>
                    </select>
                  </div>

                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
    <select name="id_dana_masuk" class="form-control" required>
        <?php 
        $mysql = "SELECT id_dana_masuk, jmlh_dana_masuk FROM danamasuk";
        $myquery = mysqli_query($koneksidb, $mysql) or die("Query error: " . mysqli_error($koneksidb));
        
        while ($mydata = mysqli_fetch_array($myquery)) {
            echo '<option value="' . $mydata['id_dana_masuk'] . '">' . $mydata['id_dana_masuk'] . ' - ' . $mydata['jmlh_dana_masuk'] . '</option>';
        }
        ?>
    </select>
</div>
